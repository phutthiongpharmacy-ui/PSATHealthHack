          ...
          <div className="flex gap-2.5 items-start p-2.5 sm:p-3 rounded-xl bg-hh-bg/60 border border-hh-border/40">
            ...
            <div>
              ...
              <ul className="space-y-0.5 text-hh-text-muted text-[11px] sm:text-xs font-hanken leading-tight">
                ...
                <li>• ระดับมัธยมศึกษาตอนปลาย ม.4, ม.5 หรือ ม.6</li>
                <li>• หรือระดับอุดมศึกษา โดยระบุมหาวิทยาลัยและคณะ</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex gap-2.5 items-start p-2.5 sm:p-3 rounded-xl bg-hh-bg/60 border border-hh-border/40">
            ...
            <div>
              ...
              <ul className="space-y-0.5 text-hh-text-muted text-[11px] sm:text-xs font-hanken leading-tight">
                ...
                <li>• สามารถรวมทีมข้ามคณะหรือข้ามสถาบันภายในระดับการศึกษาเดียวกันได้</li>
                <li>• ทีมเภสัชศาสตร์ต้องมีนักศึกษาเภสัชศาสตร์อย่างน้อย 1 คน</li>
                <li>• ค่าลงทะเบียน 700–850 บาทต่อทีมตามประเภทและรอบสมัคร</li>
              </ul>
            </div>
          </div>
