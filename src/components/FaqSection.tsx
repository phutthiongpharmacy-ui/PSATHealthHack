...
const faqData: FaqItem[] = [
  {
    ...
    answer:
      "นักเรียน ม.ปลาย, อาชีวศึกษา (ปวช., ปวส.) และนิสิตนักศึกษาระดับปริญญาตรีทุกชั้นปี ทุกคณะ จากสถาบันการศึกษาทั่วประเทศไทยที่มีอายุระหว่าง 15 – 30 ปี มีสิทธิ์สมัครเข้าร่วมแข่งขันทั้งหมด",
  },
  {
    id: "faq-2",
    question: "สมาชิกในทีมต้องอยู่คณะหรือสถาบันเดียวกันหรือไม่?",
    answer:
      "ไม่จำเป็นครับ สมาชิกในทีม (3 – 5 คน) สามารถรวมทีมข้ามคณะ ข้ามมหาวิทยาลัย หรือข้ามระดับชั้นการศึกษาได้อย่างอิสระ เพื่อส่งเสริมความหลากหลายของทักษะ เช่น เภสัชศาสตร์, คอมพิวเตอร์, การออกแบบ, และบริหารธุรกิจ",
  },
  {
    id: "faq-3",
    question: "มีค่าใช้จ่ายในการสมัครหรือเข้าร่วมโครงการหรือไม่?",
    answer:
      "การแข่งขัน PSAT HealthHack 2026 ไม่มีค่าใช้จ่ายในการสมัครใดๆ ทั้งสิ้น เข้าร่วมฟรีตลอดโครงการ พร้อมรับเกียรติบัตรอิเล็กทรอนิกส์สำหรับผู้ผ่านเข้ารอบ",
  },
  {
    id: "faq-4",
      ...
      <div className="max-w-container-max mx-auto space-y-12">
        ...
        <div className="max-w-3xl mx-auto p-8 rounded-2xl bg-hh-surface-raised/80 border border-hh-cyan/30 text-center space-y-6 shadow-2xl">
          ...
          <p className="font-hanken text-hh-text-muted text-sm max-w-lg mx-auto">
            เปิดรับสมัครตั้งแต่วันที่ 15 สิงหาคม – 20 กันยายน 2569 สมัครเป็นทีม 3-5 คน เข้าร่วมฟรีไม่มีค่าใช้จ่าย
          </p>
          <div className="pt-2">
            {onOpenEligibility ? (
              <button
